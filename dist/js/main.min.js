const dataProcessing=t=>{return t.flat().reduce((t,e)=>(t.find(t=>t.title==e.title)||t.push(e),t),[])},uniq=t=>{var s={boolean:{},number:{},string:{}},i=[];return t.filter(function(t){var e=typeof t;return e in s?!s[e].hasOwnProperty(t)&&(s[e][t]=!0):!(0<=i.indexOf(t))&&i.push(t)})},isInPage=t=>t!==document.body&&document.body.contains(t);function debonce(e,s=200){let i;return function(t){clearTimeout(i),i=setTimeout(e,s,t)}}const categoryes={action:"Экшен",indie:"Инди",shooter:"Шутер",adventures:"Приключения",strategy:"Стратегия",simulator:"Симулятор",rolePlaying:"Ролевые",race:"Гонки",mmo:"ММО",fighting:"Файтинг",casual:"Казульные",dlc:"DLC"},cardsData=[{id:1,title:"Death Stranding 1",description:"Множество игровых компаний, в том числе, EA, Ubisoft, Take-Two заявили о...",params:{payMethod:["Личный аккаунт"],category:[categoryes.action,categoryes.shooter,categoryes.mmo,categoryes.rolePlaying,categoryes.casual]},price:"359,599 ₽"},{id:2,title:"Death Stranding 2",description:"Множество игровых компаний, в том числе, EA, Ubisoft, Take-Two заявили о...",params:{payMethod:["Личный аккаунт","Семейный аккаунт"],category:[categoryes.race,categoryes.strategy,categoryes.dlc]},price:"1359,599 ₽"},{id:3,title:"Death Stranding 3",description:"Множество игровых компаний, в том числе, EA, Ubisoft, Take-Two заявили о...",params:{payMethod:["Личный аккаунт","Семейный аккаунт"],category:[categoryes.rolePlaying,categoryes.adventures]},price:"559,599 ₽"},{id:4,title:"Death Stranding 4",description:"Множество игровых компаний, в том числе, EA, Ubisoft, Take-Two заявили о...",params:{payMethod:["Личный аккаунт"],category:[categoryes.race,categoryes.indie,categoryes.strategy,categoryes.adventures,categoryes.action,categoryes.dlc,categoryes.fighting]},price:"759,599 ₽"},{id:5,title:"Death Stranding 5",description:"Множество игровых компаний, в том числе, EA, Ubisoft, Take-Two заявили о...",params:{payMethod:["Личный аккаунт"],category:[categoryes.race]},price:"259,599 ₽"},{id:6,title:"Death Stranding 6",description:"Множество игровых компаний, в том числе, EA, Ubisoft, Take-Two заявили о...",params:{payMethod:["Семейный аккаунт"],category:[categoryes.adventures,categoryes.rolePlaying,categoryes.action]},price:"2359,599 ₽"},{id:7,title:"Death Stranding 7",description:"Множество игровых компаний, в том числе, EA, Ubisoft, Take-Two заявили о...",params:{payMethod:["Личный аккаунт"],category:[categoryes.adventures,categoryes.casual,categoryes.dlc,categoryes.strategy]},price:"13359,599 ₽"},{id:8,title:"Death Stranding 8",description:"Множество игровых компаний, в том числе, EA, Ubisoft, Take-Two заявили о...",params:{payMethod:["Семейный аккаунт"],category:[categoryes.indie]},price:"5359,599 ₽"}];class Modal{constructor(t){this.options=Object.assign({isOpen:()=>{},isClose:()=>{}},t),this.modal=document.querySelector(".popup"),this.speed=!1,this.animation=!1,this._reOpen=!1,this._nextContainer=!1,this.isOpen=!1,this.modalContainer=!1,this.previousActiveElement=!1,this.fixBlocks=document.querySelectorAll(".fix-block"),this.focusElements=["a[href]","input","button","select","textarea","iframe","[contenteditable]",'[tabindex]:not([tabindex^="-"])'],this.open=this.open.bind(this),this.close=this.close.bind(this),this.focusCatch=this.focusCatch.bind(this),this.focusTrap=this.focusTrap.bind(this),this.disableScroll=this.disableScroll.bind(this),this.enableScroll=this.enableScroll.bind(this),this.lockPadding=this.lockPadding.bind(this),this.unlockPadding=this.unlockPadding.bind(this),this.events()}events(){this.modal&&(document.addEventListener("click",t=>{var e,s,i=t.target.closest("[data-path");i?(e=i.dataset.path,s=i.dataset.animation,i=i.dataset.speed,this.animation=s||"fade",this.speed=i?parseInt(i):300,this._nextContainer=document.querySelector(`[data-target="${e}"]`),this.open()):t.target.closest(".popup__close-item")&&this.close()}),window.addEventListener("keydown",t=>{27==t.keyCode&&this.isOpen&&this.close(),9==t.keyCode&&this.isOpen&&this.focusCatch(t)}),window.addEventListener("click",t=>{t.target.classList.contains("popup__wrapp")||t.target.closest(".popup__wrapp")||!this.isOpen||this.close()}))}open(t){this.previousActiveElement=document.activeElement,this.isOpen?(this.reOpen=!0,this.close()):(this.modalContainer=this._nextContainer,console.log(this.modalContainer),console.log(this._nextContainer),t&&(this.modalContainer=document.querySelector(`[data-target="${t}"]`)),this.modalContainer.scrollTo(0,0),this.modal.style.setProperty("$transition-time",this.speed/1e3+"s"),this.modal.classList.add("is-open"),document.body.style.scrollBehavior="auto",document.documentElement.style.scrollBehavior="auto",this.disableScroll(),this.modalContainer.classList.add("popup-open"),this.modalContainer.classList.add(this.animation),setTimeout(()=>{this.modalContainer.classList.add("animate-open"),this.options.isOpen(this),this.isOpen=!0,this.focusTrap()},this.speed))}close(){this.modalContainer&&(this.modalContainer.classList.remove("animate-open"),this.modalContainer.classList.remove(this.animation),this.modal.classList.remove("is-open"),this.modalContainer.classList.remove("popup-open"),this.enableScroll(),document.body.style.scrollBehavior="auto",document.documentElement.style.scrollBehavior="auto",this.options.isClose(this),this.isOpen=!1,this.focusTrap(),this.reOpen)&&(this.reOpen=!1,this.open())}focusCatch(t){var e=this.modalContainer.querySelectorAll(this.focusElements),e=Array.prototype.slice.call(e),s=e.indexOf(document.activeElement);t.shiftKey&&0===s&&(e[e.length-1].focus(),t.preventDefault()),t.shiftKey||s!==e.length-1||(e[0].focus(),t.preventDefault())}focusTrap(){var t=this.modalContainer.querySelectorAll(this.focusElements);this.isOpen?t&&t[t.length-1].focus():this.previousActiveElement.focus()}disableScroll(){var t=window.scrollY;this.lockPadding(),document.body.classList.add("disable-scroll"),document.body.dataset.position=t,document.body.style.top=-t+"px"}enableScroll(){var t=parseInt(document.body.dataset.position,10);this.unlockPadding(),document.body.style.top="auto",document.body.classList.remove("disable-scroll"),window.scrollTo({top:t,left:0}),document.body.removeAttribute("data-position")}lockPadding(){let e=window.innerWidth-document.body.offsetWidth+"px";this.fixBlocks.forEach(t=>{t.style.paddingRight=e}),document.body.style.paddingRight=e}unlockPadding(){this.fixBlocks.forEach(t=>{t.style.paddingRight="0px"}),document.body.style.paddingRight="0px"}}const filter=()=>{var t,e=[];let i=[],n=[];for(t in cardsData)e.push(cardsData[t].params.category);if(isInPage(document.getElementById("catalog-games"))){const a={catalogGames:document.getElementById("catalog-games"),filterBlock:document.querySelector(".catalog__buttons"),filterBtns:document.querySelectorAll(".catalog-btn")},r=(t,e)=>0==e||1==e?t[e]:"+"+(+t.length-2),o=e=>{var s=[];for(let t=0;t<e.length;t++)s.push(`
      ...
      `);return 3<=s.length&&s.splice(3).join(""),s.join("")})(e[t])}
          ...
          `);return s};a.catalogGames.innerHTML=o(cardsData).join("");a.filterBtns.forEach(t=>{var e;(e=t).addEventListener("click",t=>{if(t.target.closest(".catalog-btn")){t=t.target||e;const s=t.dataset.fil;if(t.classList.toggle("catalog-btn--active"),n=cardsData.filter(t=>{var e=new RegExp(s),t=t.params.category;return!!e.test(t)}),t.closest(".catalog-btn--active"))i.push(n),i=uniq(dataProcessing(i));else{t=[...document.querySelectorAll(".catalog-btn--active")];let e=[];t.forEach(t=>{t=t.dataset.fil;e.push(t)}),i=i.flat().filter(({params:t})=>t.category.some(t=>e.includes(t)))}t=o(uniq(dataProcessing(i).flat()));a.catalogGames.innerHTML=uniq(t.flat()).join("")}})})}},SliderCN="nav-content",SliderLineCN="nav-content__track",SliderItemCN="nav-content__slide",SliderDraggableCN="draggable";class NavSlider{constructor(t,e={}){this.containerNode=t,this.size=t.childElementCount,this.currentSlide=0,this.settings={scrollWidth:e.scrollWidth||null},this.setParameters=this.setParameters.bind(this),this.setEvents=this.setEvents.bind(this),this.resize=this.resize.bind(this),this.startDrag=this.startDrag.bind(this),this.stopDrag=this.stopDrag.bind(this),this.dragging=this.dragging.bind(this),this.setStylePosition=this.setStylePosition.bind(this),this.lineNode=this.containerNode.querySelector("."+SliderLineCN),this.setParameters=this.setParameters.bind(this),this.setParameters(),this.setEvents()}setParameters(){var t=this.containerNode.getBoundingClientRect();this.widthLineNodes=this.containerNode.querySelector("."+SliderLineCN).getBoundingClientRect().width,console.log(this.widthLineNodes),console.log(this.settings.scrollWidth),this.settings.scrollWidth=document.documentElement.scrollWidth,this.widthLineNodes+120>this.settings.scrollWidth&&(this.width=t.width,this.x=-this.currentSlide*this.width)}setEvents(){this.debonceResize=debonce(this.resize),window.addEventListener("resize",this.debonceResize),this.lineNode.addEventListener("pointerdown",this.startDrag),window.addEventListener("pointerup",this.stopDrag)}destroyEvents(){window.removeEventListener("resize",this.debonceResize)}resize(){this.setParameters(),this.setStylePosition()}startDrag(t){this.clickX=t.pageX,this.startX=this.x,this.containerNode.classList.add(SliderDraggableCN),window.addEventListener("pointermove",this.dragging)}stopDrag(){window.removeEventListener("pointermove",this.dragging),this.containerNode.classList.remove(SliderDraggableCN)}dragging(t){this.dragX=t.pageX;t=this.dragX-this.clickX;this.x=this.startX+t,this.setStylePosition()}setStylePosition(){this.lineNode.style.transform=`translate3d(${this.x}px, 0, 0)`,"translate3d(0px, 0px, 0px)"<=this.lineNode.style.transform?(this.lineNode.style.transform="translate3d(0px, 0, 0)",this.x=0):this.x<-Math.round(this.widthLineNodes-this.width)&&(this.lineNode.style.transform=`translate3d(${-Math.round(this.widthLineNodes-this.width+20)}px, 0, 0)`,this.x=-Math.round(this.widthLineNodes-this.width))}}const getTemplate=(t=[],e,s)=>{let i=e??"Placeholder default";e=t.map(t=>{let e="";return t.id===s&&(i=t.value,e="selected"),`
    ...
    `,this.lineNode=this.containerNode.querySelector("."+SliderLineClassName),this.dotsNode=this.containerNode.querySelector("."+SliderDotsClassName),this.slideNodes=Array.from(this.lineNode.children).map(t=>wrapElementByDiv({element:t,className:SliderItemClassName})),this.dotsNode.innerHTML=`<button class="${SliderDotClassName}"></button>`,this.btnLeft=document.querySelector("."+SliderNavLeftClassName),this.btnRight=document.querySelector("."+SliderNavRightClassName)}setParameters(){var t=this.containerNode.getBoundingClientRect();this.containerNode.querySelectorAll("."+this.settings.innerElementsClass)&&document.documentElement.scrollWidth<975?(this.containerNode.querySelectorAll("."+this.settings.innerElementsClass).forEach((t,e)=>{this.width=t.scrollWidth}),this.settings.margin=0,this.size=3*this.containerNode.querySelectorAll("."+this.settings.innerElementsClass).length):this.containerNode.querySelectorAll("."+this.settings.innerElementsClass)&&975<document.documentElement.scrollWidth&&(this.size=this.containerNode.querySelectorAll("."+this.settings.innerElementsClass).length,console.log(this.size),this.width=t.width,this.currentSlide=Math.floor(this.currentSlide/3),this.settings.margin=this.settings.margin+5),this.dotsNode.children[0].style.width="50%",this.maximumX=-(this.size-1)*(this.width+this.settings.margin),this.x=-this.currentSlide*(this.width+this.settings.margin),this.resetStyleTransition(),this.lineNode.style.width=this.size*(this.width+this.settings.margin)+"px",this.setStylePosition(),this.changeDisabledBtn(),Array.from(this.slideNodes).forEach(t=>{t.style.width=this.width+"px",t.style.marginRight=this.settings.margin+"px"})}setEvents(){this.debonceResize=debonce(this.resize),window.addEventListener("resize",this.debonceResize),this.lineNode.addEventListener("pointerdown",this.startDrag),window.addEventListener("pointerup",this.stopDrag),window.addEventListener("pointercancel",this.stopDrag),this.btnLeft.addEventListener("click",this.moveToLeft),this.btnRight.addEventListener("click",this.moveToRight)}destroyEvents(){window.removeEventListener("resize",this.debonceResize),this.lineNode.removeEventListener("pointerdown",this.startDrag),window.removeEventListener("pointerup",this.stopDrag),window.removeEventListener("pointercancel",this.stopDrag),this.btnLeft.removeEventListener("click",this.moveToLeft),this.btnRight.removeEventListener("click",this.moveToRight)}resize(){this.setParameters(),this.setStylePosition()}startDrag(t){this.currentSlideWasChanged=!1,this.clickX=t.pageX,this.startX=this.x,this.resetStyleTransition(),this.containerNode.classList.add(SliderDraggableClassName),window.addEventListener("pointermove",this.dragging)}stopDrag(){window.removeEventListener("pointermove",this.dragging),this.containerNode.classList.remove(SliderDraggableClassName),this.changeCurrentSlide()}dragging(t){this.dragX=t.pageX;var t=this.dragX-this.clickX,e=t/5;this.x=Math.max(Math.min(t+this.startX,e),this.maximumX+e),this.setStylePosition(),7<t&&0<t&&!this.currentSlideWasChanged&&0<this.currentSlide&&(this.currentSlideWasChanged=!0,this.currentSlide=this.currentSlide-1),t<-7&&t<0&&!this.currentSlideWasChanged&&this.currentSlide<this.size-1&&(this.currentSlideWasChanged=!0,this.currentSlide=this.currentSlide+1)}moveToRight(){this.currentSlide>=this.size-1||(this.currentSlide=this.currentSlide+1,this.changeCurrentSlide())}moveToLeft(){this.currentSlide<=0||(this.currentSlide=this.currentSlide-1,this.changeCurrentSlide())}changeCurrentSlide(){this.x=-this.currentSlide*(this.width+this.settings.margin),this.setStylePosition(),this.setStyleTransition(),this.changeDisabledBtn()}progressBar(){console.log(this)}changeDisabledBtn(){this.currentSlide<=0?this.btnLeft.classList.add(SliderNavDisabledClassName):this.btnLeft.classList.remove(SliderNavDisabledClassName),this.currentSlide>=this.size-1?this.btnRight.classList.add(SliderNavDisabledClassName):this.btnRight.classList.remove(SliderNavDisabledClassName)}setStylePosition(){document.documentElement.scrollWidth<975?this.lineNode.style.transform=`translate3d(${this.x/3+this.settings.margin}px, 0, 0)`:this.lineNode.style.transform=`translate3d(${this.x}px, 0, 0)`}setStyleTransition(){this.lineNode.style.transition="all 0.25s ease 0s"}resetStyleTransition(){this.lineNode.style.transition="all 0s ease 0s"}}function wrapElementByDiv({element:t,className:e}){var s=document.createElement("div");return s.classList.add(e),t.parentNode.insertBefore(s,t),s.appendChild(t),s}const selectOptions={placeholder:"Выберите способ покупки",selectedId:"1",data:[{id:"1",value:"Аренда через семейный доступ"},{id:"2",value:"Аренда через личный доступ"}],onSelect(t){}},selectOptionsBuy={placeholder:"Выберите способ покупки",data:[{id:"1",value:"Способ покупки 1"},{id:"2",value:"Способ покупки 2"},{id:"3",value:"Способ покупки 3"},{id:"4",value:"Способ покупки 4"}],onSelect(t){}},selectOptionsFilter1={placeholder:"Выберите элемент",selectedId:"1",data:[{id:"1",value:"Дате заказа"}],onSelect(t){}},selectOptionsFilter2={placeholder:"Выберите элемент",selectedId:"1",data:[{id:"1",value:"Сумме заказа"}],onSelect(t){},styles:[{background:"#3F434B;",boxShadow:"inset 0px 4px 16px rgba(0, 0, 0, 0.1);"}]},selectPurshare=new Select("#select-n",selectOptionsBuy),select1=new Select("#select-1",selectOptions),select2=new Select("#select-2",selectOptions),select3=new Select("#select-3",selectOptions),selectFilter1=new Select("#select-filter-1",selectOptionsFilter1),selectFilter2=new Select("#select-filter-2",selectOptionsFilter2),faqTabs=new Tabs("faq-tab",faqTabsOptions),profileTabs=new Tabs("profile-tab",profileTabsOptions),newSlider=(document.querySelector("#profile-tab2")&&profileTabs.switchTabs(document.querySelector("#profile-tab2")),t=>new Slider(t,{margin:20,innerElementsClass:"slider__item"})),newSlider2=t=>new Slider2(t,{margin:12}),notSlider=()=>{console.error("Слайдер на странице не существует")},modal=("loading"!==document.readyState?isInPage(document.getElementById("slider"))?newSlider(document.getElementById("slider")):notSlider():document.addEventListener("DOMContentLoaded",function(){isInPage(document.getElementById("slider"))?newSlider(document.getElementById("slider")):notSlider()}),new Modal({isOpen:t=>{},isClose:t=>{}})),navCatalog=(filter(),t=>new NavSlider(t,{scrollWidth:document.documentElement.scrollWidth}));"loading"!==document.readyState?isInPage(document.getElementById("nav-content"))&&document.documentElement.scrollWidth<1490?navCatalog(document.getElementById("nav-content")):console.error("На странице отсутствует drag and drop"):document.addEventListener("DOMContentLoaded",function(){isInPage(document.getElementById("nav-content"))?navCatalog(document.getElementById("nav-content")):console.error("На странице отсутствует drag and drop")});