function isInPage(t){return t!==document.body&&document.body.contains(t)}const categoryes={action:"Экшен",indie:"Инди",shooter:"Шутер",adventures:"Приключения",strategy:"Стратегия",simulator:"Симулятор",rolePlaying:"Ролевые",race:"Гонки",mmo:"ММО",fighting:"Файтинг",casual:"Казульные",dlc:"DLC"},cardsData=[{id:1,title:"Death Stranding 1",description:"Множество игровых компаний, в том числе, EA, Ubisoft, Take-Two заявили о...",params:{payMethod:["Личный аккаунт"],category:[categoryes.action,categoryes.shooter,categoryes.mmo,categoryes.rolePlaying,categoryes.casual]},price:"359,599 ₽"},{id:2,title:"Death Stranding 2",description:"Множество игровых компаний, в том числе, EA, Ubisoft, Take-Two заявили о...",params:{payMethod:["Личный аккаунт","Семейный аккаунт"],category:[categoryes.race,categoryes.strategy,categoryes.dlc]},price:"1359,599 ₽"},{id:3,title:"Death Stranding 3",description:"Множество игровых компаний, в том числе, EA, Ubisoft, Take-Two заявили о...",params:{payMethod:["Личный аккаунт","Семейный аккаунт"],category:[categoryes.rolePlaying,categoryes.adventures]},price:"559,599 ₽"},{id:4,title:"Death Stranding 4",description:"Множество игровых компаний, в том числе, EA, Ubisoft, Take-Two заявили о...",params:{payMethod:["Личный аккаунт"],category:[categoryes.race,categoryes.indie,categoryes.strategy,categoryes.adventures,categoryes.action,categoryes.dlc,categoryes.fighting]},price:"759,599 ₽"},{id:5,title:"Death Stranding 5",description:"Множество игровых компаний, в том числе, EA, Ubisoft, Take-Two заявили о...",params:{payMethod:["Личный аккаунт"],category:[categoryes.race]},price:"259,599 ₽"},{id:6,title:"Death Stranding 6",description:"Множество игровых компаний, в том числе, EA, Ubisoft, Take-Two заявили о...",params:{payMethod:["Семейный аккаунт"],category:[categoryes.adventures,categoryes.rolePlaying,categoryes.action]},price:"2359,599 ₽"},{id:7,title:"Death Stranding 7",description:"Множество игровых компаний, в том числе, EA, Ubisoft, Take-Two заявили о...",params:{payMethod:["Личный аккаунт"],category:[categoryes.adventures,categoryes.casual,categoryes.dlc,categoryes.strategy]},price:"13359,599 ₽"},{id:8,title:"Death Stranding 8",description:"Множество игровых компаний, в том числе, EA, Ubisoft, Take-Two заявили о...",params:{payMethod:["Семейный аккаунт"],category:[categoryes.indie]},price:"5359,599 ₽"}];class Modal{constructor(t){this.options=Object.assign({isOpen:()=>{},isClose:()=>{}},t),this.modal=document.querySelector(".popup"),this.speed=!1,this.animation=!1,this._reOpen=!1,this._nextContainer=!1,this.isOpen=!1,this.modalContainer=!1,this.previousActiveElement=!1,this.fixBlocks=document.querySelectorAll(".fix-block"),this.focusElements=["a[href]","input","button","select","textarea","iframe","[contenteditable]",'[tabindex]:not([tabindex^="-"])'],this.open=this.open.bind(this),this.close=this.close.bind(this),this.focusCatch=this.focusCatch.bind(this),this.focusTrap=this.focusTrap.bind(this),this.disableScroll=this.disableScroll.bind(this),this.enableScroll=this.enableScroll.bind(this),this.lockPadding=this.lockPadding.bind(this),this.unlockPadding=this.unlockPadding.bind(this),this.events()}events(){this.modal&&(document.addEventListener("click",t=>{var e,s,i=t.target.closest("[data-path");i?(e=i.dataset.path,s=i.dataset.animation,i=i.dataset.speed,this.animation=s||"fade",this.speed=i?parseInt(i):300,this._nextContainer=document.querySelector(`[data-target="${e}"]`),this.open()):t.target.closest(".popup__close-item")&&this.close()}),window.addEventListener("keydown",t=>{27==t.keyCode&&this.isOpen&&this.close(),9==t.keyCode&&this.isOpen&&this.focusCatch(t)}),window.addEventListener("click",t=>{t.target.classList.contains("popup__wrapp")||t.target.closest(".popup__wrapp")||!this.isOpen||this.close()}))}open(t){this.previousActiveElement=document.activeElement,this.isOpen?(this.reOpen=!0,this.close()):(this.modalContainer=this._nextContainer,console.log(this.modalContainer),console.log(this._nextContainer),t&&(this.modalContainer=document.querySelector(`[data-target="${t}"]`)),this.modalContainer.scrollTo(0,0),this.modal.style.setProperty("$transition-time",this.speed/1e3+"s"),this.modal.classList.add("is-open"),document.body.style.scrollBehavior="auto",document.documentElement.style.scrollBehavior="auto",this.disableScroll(),this.modalContainer.classList.add("popup-open"),this.modalContainer.classList.add(this.animation),setTimeout(()=>{this.modalContainer.classList.add("animate-open"),this.options.isOpen(this),this.isOpen=!0,this.focusTrap()},this.speed))}close(){this.modalContainer&&(this.modalContainer.classList.remove("animate-open"),this.modalContainer.classList.remove(this.animation),this.modal.classList.remove("is-open"),this.modalContainer.classList.remove("popup-open"),this.enableScroll(),document.body.style.scrollBehavior="auto",document.documentElement.style.scrollBehavior="auto",this.options.isClose(this),this.isOpen=!1,this.focusTrap(),this.reOpen)&&(this.reOpen=!1,this.open())}focusCatch(t){var e=this.modalContainer.querySelectorAll(this.focusElements),e=Array.prototype.slice.call(e),s=e.indexOf(document.activeElement);t.shiftKey&&0===s&&(e[e.length-1].focus(),t.preventDefault()),t.shiftKey||s!==e.length-1||(e[0].focus(),t.preventDefault())}focusTrap(){var t=this.modalContainer.querySelectorAll(this.focusElements);this.isOpen?t&&t[t.length-1].focus():this.previousActiveElement.focus()}disableScroll(){var t=window.scrollY;this.lockPadding(),document.body.classList.add("disable-scroll"),document.body.dataset.position=t,document.body.style.top=-t+"px"}enableScroll(){var t=parseInt(document.body.dataset.position,10);this.unlockPadding(),document.body.style.top="auto",document.body.classList.remove("disable-scroll"),window.scrollTo({top:t,left:0}),document.body.removeAttribute("data-position")}lockPadding(){let e=window.innerWidth-document.body.offsetWidth+"px";this.fixBlocks.forEach(t=>{t.style.paddingRight=e}),document.body.style.paddingRight=e}unlockPadding(){this.fixBlocks.forEach(t=>{t.style.paddingRight="0px"}),document.body.style.paddingRight="0px"}}if(isInPage(document.getElementById("catalog-games"))){const v={catalogGames:document.getElementById("catalog-games"),filterBlock:document.querySelector(".catalog__buttons"),filterBtns:document.querySelectorAll(".catalog-btn")};let n=0;const x=(t,e)=>0==e||1==e?t[e]:"+"+(+t.length-2),y=e=>{var s=[];for(let t=0;t<e.params.category.length;t++)s.push(`
    ...
    `);return 3<=s.length&&s.splice(3).join(""),s.join("")},z=e=>{var s=[];for(let t=0;t<e.length;t++)s.push(`
      <div class="game-card" data-id="${t+1}">
        ...
        `);return s},A=(v.catalogGames.innerHTML=z(cardsData).join(""),a=>{a.addEventListener("click",t=>{if(t.target.closest(".catalog-btn")){var e=t.target||a;const i=e.dataset.fil;var s=cardsData.filter(t=>{var e=new RegExp(i),t=t.params.category;return!!e.test(t)}),s=z(s);e.closest(".catalog-btn-active")||0==n?(e.classList.remove("catalog-btn-active"),n++,v.catalogGames.innerHTML=s.join("")):t.target&&(e.classList.add("catalog-btn-active"),v.catalogGames.innerHTML+=s.join(""))}})})}const getTemplate=(t=[],e,s)=>{let i=e??"Placeholder default";e=t.map(t=>{let e="";return t.id===s&&(i=t.value,e="selected"),`
